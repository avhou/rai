...
Table: Slope values \label{table:slopes}
...
These results show only moderate changes in discussed topics.  As a partial explanation for these results, we can note : 
